...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'lihj@dev.lihj.me',
  ...
  protectedRoutes: ['/文档', '/应用'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:lihj@dev.lihj.me',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/L1H0n9Jun',
    },
  ],
